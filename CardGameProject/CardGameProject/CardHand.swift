...
struct cardHand {
    ...
    init(player: handType) {
        ...
        case .player2:
            ...
            let position1 = CGPoint(x: 123.915, y: 655.28)
            let position2 = CGPoint(x: 135.279, y: 632.98)
            let position3 = CGPoint(x: 152.977, y: 615.28)
            let position4 = CGPoint(x: 175.279, y: 603.92)
            let position5 = CGPoint(x: 200, y: 600)
            let position6 = CGPoint(x: 224.721, y: 603.92)
            let position7 = CGPoint(x: 247.023, y: 615.28)
            let position8 = CGPoint(x: 264.721, y: 632.98)
            let position9 = CGPoint(x: 276.085, y: 655.28)
            let position10 = CGPoint(x: 280, y: 680)
            
            //
            
            let rotation1 = (3 * CGFloat.pi / 2) + 7 * CGFloat.pi / 6
            let rotation2 = (3 * CGFloat.pi / 2) + 5 * CGFloat.pi / 4
            let rotation3 = (3 * CGFloat.pi / 2) + 4 * CGFloat.pi  / 3
            let rotation4 = (3 * CGFloat.pi / 2) + 17 * CGFloat.pi / 12
            let rotation5 = (3 * CGFloat.pi / 2) + 3 * CGFloat.pi / 2
            let rotation6 = (3 * CGFloat.pi / 2) + 19 * CGFloat.pi / 12
            let rotation7 = (3 * CGFloat.pi / 2) + 5 * CGFloat.pi / 3
            let rotation8 = (3 * CGFloat.pi / 2) + 7 * CGFloat.pi / 4
            let rotation9 = (3 * CGFloat.pi / 2) + 11 * CGFloat.pi / 6
            let rotation10 = (3 * CGFloat.pi / 2) + 23 * CGFloat.pi / 12
